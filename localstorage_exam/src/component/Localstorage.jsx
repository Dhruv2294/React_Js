...
export const LocalStorage = () => {
     ...
     const [initialInfo] = useState({ fname: "", email: "",  mno: "" });
     ...
     const HandleSubmit = (e) => {
          ...
          if (!info.fname || !info.email || !info.mno) {
          ...
          <>
               <div>
                    <form action="" className="text-center mt-5 text-light">
                         ...
                         <br /><br />
                         <label htmlFor="mno" className="pe-3 fw-bold" >Mobile: </label>
               ...
               <table className="table table-bordered border-dark w-75 mt-5 ms-5">
                    <thead>
                         ...
                         <th className="ps-5 border border-dark text-light">Mobile</th>
